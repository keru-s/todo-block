...
- 直接下载：[Todo-Block-macOS.dmg](https://github.com/keru-s/todo-block/releases/latest/download/Todo-Block-macOS.dmg)
...
1. 从 Releases 下载 DMG 安装镜像。
2. 双击打开镜像，把 `todo block.app` 拖到“应用程序”文件夹。
...
触发后，GitHub Action 会自动构建 Release 版本、生成 `Todo-Block-macOS.dmg`，并把它挂到 GitHub Release 页面。
